 ...
 */
 class TodoView {
    ...
    constructor() {
      ...
      this.form = this.createElement("form", "add-todo");
    ...
    public displayTodos(todos: any[]) {
      ...
      if (todos.length === 0) {
        const p = this.createElement("p", "info");
        ...
        todos.forEach(todo => {
          ...
          if (todo.complete) {
            const strike = this.createElement("s", "strike");
    ...
    public bindDeleteTodo(handler: (arg0: any) => void) {
    ...
    public bindEditTodo(handler: (arg0: any, arg1: string) => void) {
    ...
    public bindToggleTodo(handler: (arg0: any) => void) {
